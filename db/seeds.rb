...
Document.create(document_section: "PC" , document_level: "1" , document_type: "Résumé")
Document.create(document_section: "PC" , document_level: "1" , document_type: "Concour")
Document.create(document_section: "PC" , document_level: "1" , document_type: "Devoir")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Série")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Résumé")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Devoir")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Examen")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Résumé")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Série")
Document.create(document_section: "PB" , document_level: "1" , document_type: "ConcourDevoir")
Document.create(document_section: "PB" , document_level: "1" , document_type: "Examen")
Document.create(document_section: "PB" , document_level: "1" , document_type: "Série")

Document.create(document_section: "PC" , document_level: "1" , document_type: "Résumé" , document_course: "Math" , document_year: "2011")
Document.create(document_section: "PC" , document_level: "1" , document_type: "Concour" , document_course: "Physique" , document_year: "2011")
Document.create(document_section: "PC" , document_level: "1" , document_type: "Devoir" , document_course: "Physique" , document_year: "2016")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Série" , document_course: "Math" , document_year: "2016")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Résumé" , document_course: "Physique" , document_year: "2016")
Document.create(document_section: "MP" , document_level: "1" , document_type: "Devoir" , document_course: "Physique" , document_year: "2011")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Examen" , document_course: "Physique" , document_year: "2016")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Résumé" , document_course: "Physique" , document_year: "2016")
Document.create(document_section: "PT" , document_level: "1" , document_type: "Série" , document_course: "Physique" , document_year: "2014")
Document.create(document_section: "PB" , document_level: "1" , document_type: "ConcourDevoir" , document_course: "Physique" , document_year: "2012")
Document.create(document_section: "PB" , document_level: "1" , document_type: "Examen" , document_course: "Physique" , document_year: "2014")
Document.create(document_section: "PB" , document_level: "1" , document_type: "Série" , document_course: "Physique" , document_year: "2014")
