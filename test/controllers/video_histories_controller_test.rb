...
class VideoHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create video_history" do
    assert_difference('VideoHistory.count') do
      post video_histories_url, params: { video_history: { user_id: @video_history.user_id, video_id: @video_history.video_id } }
    end
  ...
  test "should update video_history" do
    patch video_history_url(@video_history), params: { video_history: { user_id: @video_history.user_id, video_id: @video_history.video_id } }
