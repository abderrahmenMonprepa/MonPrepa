...
class InstitutesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create institute" do
    assert_difference('Institute.count') do
      post institutes_url, params: { institute: { institute_name: @institute.institute_name, institute_other: @institute.institute_other, institute_type: @institute.institute_type } }
    end
  ...
  test "should update institute" do
    patch institute_url(@institute), params: { institute: { institute_name: @institute.institute_name, institute_other: @institute.institute_other, institute_type: @institute.institute_type } }
